...
{
    public partial class DBSISTEMAVENTASContext : DbContext
    {
        public DBSISTEMAVENTASContext()
        {
        }

        public DBSISTEMAVENTASContext(DbContextOptions<DBSISTEMAVENTASContext> options)
            : base(options)
        {
        }
